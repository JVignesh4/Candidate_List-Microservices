...
@ControllerAdvice
public class CandidateBankExceptionHandler {
    ...
    @ExceptionHandler(CandidateBankException.class)
    public ResponseEntity<ResponseDTO> handleCustomException(CandidateBankException bookStoreException) {
