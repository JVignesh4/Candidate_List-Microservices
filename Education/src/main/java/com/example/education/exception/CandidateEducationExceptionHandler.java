...
import java.util.stream.Collectors;
    ...
    @ControllerAdvice
    public class CandidateEducationExceptionHandler {
        ...
        @ExceptionHandler(CandidateEducationException.class)
        public ResponseEntity<ResponseDTO> handleCustomException(CandidateEducationException bookStoreException) {
